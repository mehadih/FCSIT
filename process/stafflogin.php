...
if (isset($_POST['login'])) {
      $username = filter_var($_POST['staffName'], FILTER_SANITIZE_STRING);
      ...
      $query = "SELECT * FROM staff WHERE name = :name";
          ...
          if (password_verify($password_1,$password)) {
           ...
           // echo "<br>no<br>";
            ...
            header('Location:../views/stafflogin.php');
...
//logout
    ...
    if (isset($_POST['changePassword'])) {
      ...
      $_SESSION["msg_type"] = "danger";
      header('Location:../views/staffsettings.php');

    }else {
      // code...
      $hashed_password = password_hash($confirmPassword, PASSWORD_DEFAULT);

      $stmt = $conn ->prepare("UPDATE staff SET password = :confirmPassword WHERE id=$USER_ID");
