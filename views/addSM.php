          ...
          <div class="container">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <form action="../process/addsm.php" method="post">
                  <div class="form-group">
                    <label for="">Name</label>
                    <input class="form-control" type="text" name="SMName" required>
                  </div>
                  <div class="form-group">
                  ...
                  <button class="btn btn-info"type="submit" name="AddSM">ADD</button>
                </form>
              </div>
            </div>
