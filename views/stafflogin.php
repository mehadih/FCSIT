    ...
    <div class="container-fluid">
      ...
      <div class="col-lg-6 col-sm-12">
        <div class="card panel">
          ...
          <div class="card-body">
            <form action="../process/stafflogin.php" method="post" autocomplete="off">
              <div class="form-group">
                <label for="">User Name</label>
                <input class="form-control" type="text" name="staffName" required  placeholder="Enter an User Name">
              </div>
              <div class="form-group">
