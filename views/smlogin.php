      ...
      <div class="col-lg-6 col-sm-12">
        <div class="card panel">
          <div class="card-header text-center">
            <h1>LOG IN</h1>
            <h6 class="text-muted">Support Manager</h6>
          </div>
          <div class="card-body">
            <form action="../process/smlogin.php" method="post" autocomplete="off">
              <div class="form-group">
                <label for="">User Name</label>
                <input class="form-control" type="text" name="SMName" required  placeholder="Enter an User Name">
              </div>
              <div class="form-group">
