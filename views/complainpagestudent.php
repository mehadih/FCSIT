                 ...
                 <h1 class="display-4">FCSIT Support</h1>
                  ...
                  <div class="row">
                    <div class="col-lg-6 col-sm-12">
                      <form action="../process/registercomplain.php" method="post">
                        ...
                        <div class="form-group">
                          ...
                          <a href="complainimagestudent.php?id=<?php echo $value['id'];?>" class="btn btn-info">View</a>
                        </div>
                        <div class="form-group">
                        ...
                        <button class="btn btn-danger"type="submit" name="deleteComplain">Delete</button>
                      </form>
                    </div>
                  </div>
               </div>
