...
if (!isset($_SESSION['ADMINNAME'])){
     ...
     //Fetch Data
         try {
                 // FETCH DATA of Support Manager
                 $stmt = $conn->prepare("SELECT * FROM supportmanager");
                 $stmt->execute();
                 // set the resulting array to associative
                 $result = $stmt->setFetchMode(PDO::FETCH_ASSOC);

                 // FETCH DATA of staff
                 $stmt2 = $conn->prepare("SELECT * FROM staff");
                 $stmt2->execute();
                 // set the resulting array to associative
      ...
      <?php require 'sub-views/admindashside.php'; ?>
        ...
        <!-- <div id="main"> -->
          <div class="container" id="main">
              <h3 class="display-4">Welcome <?php echo$_SESSION['ADMINNAME']; ?>.</h3>
            <div class="card-deck">
              <div class="card text-white bg-dark">
                <div class="card-body">
                  ...
                  <p class="card-text">Support Manager Account operations handle here.</p>
                  <a href="smaccount.php" class="btn btn-info">View</a>
                <?php }
                } catch (PDOException $e) {
                  //throw $th;
              ...
              <div class="card text-white bg-dark">
                ...
                <a href="staffaccount.php" class="btn btn-info">View</a>
