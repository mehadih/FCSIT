  ...
  <body class="text-center">
    <div class="container-fluid">
            ...
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <a class="dropdown-item" href="smlogin.php">Support Manager</a>
      ...
      <div class="jumbotron jumbotron-fluid">
        <div class="container">
          <h1 class="display-4">FCSIT Supports</h1>
          <p class="lead">Register your complains through this portal. It has service to forward complains to higher level if action is not taken by staffs within time.</p>
        </div>
      </div>
