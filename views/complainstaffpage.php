 ...
 <html lang="en">
   ...
   <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
     ...
     <div class="collapse navbar-collapse" id="navbarSupportedContent">
         ...
         <ul class="navbar-nav">
           <form class="form-inline" action="../process/stafflogin.php" method="post">
   ...
   <body>
    ...
    <div class="container-fluid">
      <?php require 'sub-views/staffsidenav.php'; ?>
      ...
      <div id="main">
        ...
        $sql = "SELECT * FROM complain WHERE id=$case_id";
        ...
        ?>
            ...
            <div class="bx">
              <div class="shadow-lg p-3 mb-5 bg-white rounded">
                <h1 class="display-4">FCSIT Support</h1>
                 ...
                 <div class="row">
                   <div class="col-lg-6 col-sm-12">
                       ...
                       <div class="form-group">
                         <label for="">Matric No.<span class="text-danger">*</span></label>
                         <h5 class="lead"><?php echo $value['matricno'];  ?></h5>
                       </div>
                       <div class="form-group">
                       ...
                       <label class="lead"> <mark>Complain Details</mark></label>
                       <br>
                       <div class="form-group">
                         <label for="">Complain Reg.No.</label>
                         <h5 class="lead"><?php echo $value['id'];  ?></h5>
                       </div>
                       <div class="form-group">
                         <label for="">Complain Type<span class="text-danger">*</span></label>
                         <h5 class="lead"><?php echo $value['complaintype'];  ?></h5>
                       </div>
                       <div class="form-group">
                         <label for="">File Attachement</label>
                         <a href="complainimagestaff.php?id=<?php echo $value['id'];?>" class="btn btn-info">View</a>
                       </div>
                       <div class="form-group">
                       ...
                       <div class="form-group">
                         <label class="">Description of Complain<span class="text-danger">*</span></label>
                         <p class="lead"><?php echo $value['description'];  ?></p>
                       </div>
                       <hr>
                       <form class="form-inline" action="../process/complainprocessS.php" method="post">

                      <div class="form-group">
                        <label for="">Choose Action</label>
                        <select name="complainStatus" class="custom-select mr-sm-2" required id="inlineFormCustomSelect">
