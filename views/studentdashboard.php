...
if (!isset($_SESSION['USERNAMES'])){
     ...
     try {
             ...
             $stmt = $conn->prepare("SELECT * FROM complain WHERE user_id='$USER_ID'");
             $stmt->execute();
      ...
      <?php require 'sub-views/studentsidenav.php'; ?>
       ...
       <div id="main">
         <div class="container">
           ...
           <hr>
           <h5 class="dispay-4">Previous Complains</h5>
               ...
               <tbody>
                 ...
                 <tr>
                   ...
                   <td>
                    ...
                    <td>
                      <a href="complainpagestudent.php?id=<?php echo $value['id'];?>" class="btn btn-info">View</a>
                    </td>
