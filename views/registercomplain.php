                 ...
                 <h1 class="display-4">FCSIT Support</h1>
                  ...
                  <div class="row">
                    <div class="col-lg-6 col-sm-12">
                      <form action="../process/registercomplain.php" enctype="multipart/form-data" method="post" autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <input class="form-control" type="text" name="studentMatricNo" required  placeholder="Enter Matric No.">
                        </div>
                        <div class="form-group">
                        ...
                        <br>
                        <div class="form-group">
                          <label for="">Choose Complain Type<span class="text-danger">*</span></label>
                          <select name="complainType" class="custom-select mr-sm-2" id="inlineFormCustomSelect">
                            ...
                            <option value="Accounts Related">Accounts Related</option>
